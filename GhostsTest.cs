...
namespace hashes
{
	...
	public class GhostsTest
	{
		...
		{
			AssertThatDoMagicBreaksHashSet<Vector, My_GhostsTask>();
		}

		[Test]
		public void GhostSegmentBreaksHashSet()
		{
			AssertThatDoMagicBreaksHashSet<Segment, My_GhostsTask>();
		}

		[Test]
		public void GhostCatBreaksHashSet()
		{
			AssertThatDoMagicBreaksHashSet<Cat, My_GhostsTask>();
		}

		[Test]
		public void GhostDocumentBreaksHashSet()
		{
			AssertThatDoMagicBreaksHashSet<Document, My_GhostsTask>();
		}

		[Test]
		public void GhostRobotBreaksHashSet()
		{
			AssertThatDoMagicBreaksHashSet<Robot, My_GhostsTask>();
		}
